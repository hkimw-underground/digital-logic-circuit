...
This section tracks issue proposals generated by Jules that require manual creation by a human maintainer.

- [ ] **Document AI-Assisted Coding Safety Boundaries**
  - **Source:** `docs/proposals/safety-boundary-issue.md`
  - **Goal:** Explicitly document what Jules may assist with and what requires human review to protect hardware/security integrity.
