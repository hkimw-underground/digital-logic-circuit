...
| **물리 보안** | 구동부 노출 위험 | 서보 링크나 잠금 구동부가 외부에 노출될 경우 물리적인 조작만으로 잠금장치를 해제할 수 있다. | 모든 핵심 제어 회로는 보안 구역(Secure-side) 내부의 견고한 함체에 장착되어야 한다. |
...
*   **정격 전압 준수:** MFRC522는 3.3V, 서보와 부저는 5V 기준으로 연결한다. 서보 구동 시 전류 여유가 부족하면 떨림이나 보드 재부팅이 발생할 수 있다.
